...
- `mcp-orchestrator` - Java MCP Orchestrator
- `search-orchestrator` - Search Orchestration Service
...
| Command | Description |
|---------|-------------|
| `./foodbot logs` | Show logs for all services |
| `./foodbot logs [SERVICE]` | Show logs for a specific service |
| `./foodbot ps` | Show status of all services |
