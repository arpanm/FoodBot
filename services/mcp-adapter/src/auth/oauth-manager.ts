...
/**
 * @deprecated This is a legacy OAuth 2.0 implementation that does NOT comply with OAuth 2.1 (RFC 9126).
 * It lacks PKCE (code_challenge/code_verifier) support, making it vulnerable to authorization code
 * interception attacks.
 *
 * New code should use {@link OAuthService} from `./oauth.service.ts` instead, which implements
 * OAuth 2.1 with full PKCE support.
 *
 * This class should be removed once all consumers have migrated to OAuthService.
 */
export class OAuthManager {
  ...
  constructor(stateStore: TokenStore) {
    console.warn('[DEPRECATED] OAuthManager is deprecated. Use OAuthService which implements OAuth 2.1 with PKCE.');
